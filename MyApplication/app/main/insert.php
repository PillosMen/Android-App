...
$database_localhost ="cutclass";//Nombre de nuestra base de datos
...
$query_search = "insert into personas(nombre,codigo,telefono,email) values ('".$nombre."','".$dni."','".$telefono."','".$email."')";//Sentencia sql a realizar
