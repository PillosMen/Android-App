...
public class u3_ed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_u3_ed);
    ...
    public void guardarEncuesta(View v){
        ...
        }else if (r1_c.isChecked() || r1_b.isChecked()  ){
        ...
        }else if (r2_a.isChecked() || r2_b.isChecked() ){
